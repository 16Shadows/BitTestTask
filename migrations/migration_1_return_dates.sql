/*
    Скрипт для обновления схемы БД и добавления дат ожидаемого возврата книг.
*/
...
SELECT ID, StartDate, COALESCE(ReturnDate, StartDate), ReturnDate, BookID, ClientID FROM Loan;
